    ...
    ["particles-js", {
        "particles":{
            "number":{
                "value":66,
                "density":{
                    "enable":false,"value_area":1417.881055533674}},
            "color":{
                "value":"#5ec7ff"},
            "shape":{
                "type":"circle","stroke":{"width":2,"color":"#68d9f9"},"polygon":{"nb_sides":12},"image":{"src":"dna/github.svg","width":50,"height":50}},
            "opacity":{
                "value":0.48838125246159886,"random":true,"anim":{"enable":false,"speed":1,"opacity_min":0.1,"sync":false}},
            "size":{
        ...
        "interactivity":{
            "detect_on":
                "canvas",
                "events":{
                    "onhover":{"enable":true,"mode":"grab"},"onclick":{"enable":true,"mode":"push"},"resize":true},
                "modes":{
